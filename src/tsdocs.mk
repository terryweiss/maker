...
ifneq (HTML-DOCS-DIR,)
	@${TIME} ${DOCS-TOOL} --out ${DOCS-OUT}/html --options ${TYPEDOC-CONFIG-FILE} --includes ./  ${SRC-DIR}
endif
ifneq (MD-DOCS-DIR,)
	@${TIME} ${DOCS-TOOL} --out ${DOCS-OUT}/md --options ${TYPEDOC-CONFIG-FILE} --theme markdown --mdEngine gitbook --includes ./ ${SRC-DIR}
endif	
	@${TOUCH} -m ${DOCS-OUT}
