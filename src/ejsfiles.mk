...
EJS-FILES-OUT := $(subst ${SRC-DIR}/,${OUT-DIR}/,${EJS-FILES})##@ejsfile-mk This is the full output, use this variable in your build dependencies
EJS-OUT := ${OUT-DIR}/${EJS-TEMPLATES-DIR}/%.ejs
