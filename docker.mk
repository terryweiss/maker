...
ifeq (${DOCKER-PUBLISH-LATEST},true)
	...
	${call start-msg,Building Docker container ${DOCKER-REGISTRY-URL}/${DOCKER-NAME}:${THIS_VERSION}}
	@${DOCKER} push ${DOCKER-REGISTRY-URL}/${DOCKER-NAME}:${THIS_VERSION}	
	${call end-msg,Building Docker container ${DOCKER-REGISTRY-URL}/${DOCKER-NAME}:${THIS_VERSION}}
