EJSFILE-MK.DESCRIPTION:=##@ejsfile-mk Got some ejs or other template files you want to accompany your code? This is the right place.
...
EJS-FILES-OUT = $(EJS-FILES:.${EJS-EXTENSION}=.${EJS-EXTENSION})
